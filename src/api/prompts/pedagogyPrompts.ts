...
export const getPedagogyAnalysisPrompt = (
    content: string,
    type: 'course' | 'project'
): string => {
    const typeLabel = type === 'course' ? 'educational course' : 'capstone project';
    
    return `You are an Expert Educational Auditor and Instructional Designer.
    
**Task:** Analyze the provided ${typeLabel} content and "prove" how it adheres to advanced pedagogical frameworks. You must generate specific evidence based on the actual text provided.
