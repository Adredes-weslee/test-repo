...
export const PedagogyInfo: React.FC<PedagogyInfoProps> = ({ analysis, isLoading }) => {
    
    if (!analysis && !isLoading) {
        return <p className="text-sm text-slate-500 italic p-4">Pedagogical analysis will appear here after generation.</p>;
    }
